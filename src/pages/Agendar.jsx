    ...
    return (
      <div style={wrap}>
        <div style={{ ...card, textAlign: 'center' }}>
          ...
          <p style={{ marginTop: 18, color: '#67756c', fontSize: 14 }}>Ya puedes cerrar esta página. Si quieres conocernos mejor, visita{' '}
            <a href="https://conectanex.es" target="_blank" rel="noopener noreferrer" style={{ color: '#0c7b6d', fontWeight: 700, textDecoration: 'none' }}>conectanex.es</a>.</p>
        </div>
      </div>
    );
  }
